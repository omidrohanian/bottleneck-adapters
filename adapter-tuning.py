...
SAVE_PATH = "PATH_TO_CHECKPOINTS/biomedical_model_checkpoints/bert-adapter"
...
config = ts.AdapterConfig(mh_adapter=True, output_adapter=True, reduction_factor=16, non_linearity="relu")
